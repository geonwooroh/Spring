...
public class RequestParamController {
	...
	/*
	 * @RequestParam
	 * - String, int 등의 단순 타입이면 @RequestParam 생략가능
	 * 주의사항
	...
	public String requestparamMap(@RequestParam Map<String, Object> paramMap)
		...
		System.out.println("userage: "+paramMap.get("age"));
	...
	public String requestAttributeV1(@RequestParam String username,
									@RequestParam int age)  {
		...
		System.out.println("userage: "+helloData.getAge());
	 ...
	 * - 요청 파라미터의 이름으로 HelloData 객체의 프로퍼티를 갖는다.
	 * 그리고 해당 프로퍼티의 setter를 호춯ㅎ해서 파라미터의 값을 입력(바인딩)한다.
	 * 
	 * */
	@ResponseBody
